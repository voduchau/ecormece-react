        ...
        <div className="dashboard__menu">
            ...
            <nav className="dashboard__menu-nav">
                <ul className="dashboard__menu-nav-ul">
                    ...
                    <li className={`dashboard_meunu-item ${isActive[1] ? 'active' : null}`} onClick={() => handleChangeTab(1)}>
                        <CategoryIcon />
                        <span>Categories</span>
                    </li>
                    <li className={`dashboard_meunu-item ${isActive[2] ? 'active' : null}`} onClick={() => handleChangeTab(2)}>
                        <LocalShippingIcon />
                        <span>Order</span>
                    </li>
                    <li className={`dashboard_meunu-item ${isActive[3] ? 'active' : null}`} onClick={() => handleChangeTab(3)}>
                        <CreateIcon />
                        <span>Blogs</span>
                    </li>
                </ul>
